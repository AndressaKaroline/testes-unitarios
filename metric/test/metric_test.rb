...
class MetricTest < Minitest::Test
  ...
  def test_km_to_inch
    assert_equal 236_220, Metric.new(6, 'km').to_inch
  end
  ...
  def test_mile_to_inch
    assert_equal 190_080, Metric.new(3, 'mile').to_inch
  end
  ...
  def test_km_to_m
    assert_equal 40_000, Metric.new(40, 'km').to_m
  end
  ...
  def test_mile_to_m
    assert_equal 101_388.67, Metric.new(63, 'mile').to_m
  end
  ...
  def test_km_to_cm
    assert_equal 18_000_000, Metric.new(180, 'km').to_cm
  end
  ...
  def test_mile_to_cm
    assert_equal 804_672, Metric.new(5, 'mile').to_cm
  end
  ...
  def test_km_to_foot
    assert_equal 183_727.04, Metric.new(56, 'km').to_foot
  end
  ...
  def test_mile_to_foot
    assert_equal 718_080, Metric.new(136, 'mile').to_foot
  end
  ...
  def test_km_to_yard
    assert_equal 10_936.13, Metric.new(10, 'km').to_yard
  end
  ...
  def test_mile_to_yard
    assert_equal 45_760, Metric.new(26, 'mile').to_yard
  end
