...
class Metric
  ...
  def to_inch
    ...
    when 'yard'
      p (@value * 36).round(2)
    when 'km'
      p (@value * 39_370).round(2)
    when 'foot'
      p (@value * 12).round(2)
    when 'mile'
      p (@value * 63_360).round(2)
    else
      p 'Erro na conversão!'
    end
  end
  ...
  def to_cm
    ...
    when 'km'
      p (@value * 100_000).round(2)
    when 'foot'
      p (@value * 30.48).round(2)
    when 'mile'
      p (@value * 160_934.4).round(2)
    else
      p 'Erro na conversão!'
    end
  end
  ...
  def to_km
    case @unit
    when 'inch'
      p (@value / 39_370.079).round(2)
    when 'cm'
      p (@value / 100_000.0).round(2)
    when 'm'
